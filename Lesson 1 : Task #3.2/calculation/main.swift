...
// Програма не вміє працювати з від'ємними числами - наприклад -4+5 крешиить
// Також крешиться при введенні не валідної строки (------) - було б непогано додати валідацію
